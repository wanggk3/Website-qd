<template>
  <div>
    <el-carousel trigger="click" height="700px" @change="loadAnimate">
    ...
    <div class="home-service">
      ...
      <p>
        引进与吸收了国内外数十位行业资深人才，聚集行业先进的产品与技术，满足不同的客户需求并提供最优解决方案，共创价值
      </p>
      <ul>
      ...
      <div class="friends-container">
        ...
        <ul>
          <li v-for="item in 6" :key="item">
            <img
              :src="`../../../static/img/friends/clients-logo0${item}.png`"
            />
          </li>
        </ul>
      </div>
      ...
      services: [
        {
          title: "政府机构",
          info:
            "“纵向到企业、横向跨行业、覆盖全工业”，实现供给侧与需求侧双向互动。",
        },
        {
          title: "服务机构",
          info:
            "提供平台、智能终端、能效产品与新技术，实现“能源互联网+售电+能源服务”的综合能源服务。",
        },
        {
          title: "能源用户",
          info:
            "提供能源管理系统装备、技术、人才的整体服务解决方案，降低生产成本，提高竞争力。",
        },
      ],
    };
  },
